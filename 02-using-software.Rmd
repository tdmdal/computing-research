...
Note: For conda 4.6 or later version, you can use `conda activate r-env` to activate the environment. The default conda version on RNN is 4.5.11 (use `conda --version` to see it). However, if you still want to use `conda activate r_env` (for future proof), do the following.
